...
import com.app.Service.GroceryService;
 ...
 * and configuration properties support in a Spring Boot application.
 * 
 * This class initializes the Spring application context and demonstrates basic CRUD operations
 * using GroceryService and StoreService.
 */
